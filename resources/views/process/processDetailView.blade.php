                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row w-100 mx-auto">
                          ...
                          <input id ="programStatus" type="text" class="col-md-1 form-control form-control-sm align-self-center text-center font-weight-bold" value="{{$processDetail[0]->status}}" readonly>
                      </div>
                      <hr>
                      <div class="row w-100 mx-auto">
