    ...
    <div class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <!-- DataTales Example -->
          <h4 class="h3 my-4 font-weight-bold" style="color:white">대분류 코드 관리</h4>
              ...
              <div class="d-none d-sm-inline-block form-inline ml-auto my-2 my-md-0 mw-100 navbar-search">
                <div class="input-group align-items-center">
                  ...
                  @elseif(isset($searchWord))
                    ...
                    <input id="searchWord" type="text" value="" class="form-control bg-light small" aria-label="Search">
                  ...
                  <div class="input-group-append">
                    <div class="btn btn_orange" onclick="code.largeSearch('1')">
                      <i class="fas fa-search fa-sm" style="color:white"></i>
                    </div>
                  </div>
                  <button type="button" class="btn btn_orange mx-2" onclick="pageMove.admin.register('commonCodeLargeRegisterView')">등록</button>
                </div>
              </div>
            </div>
