...
{{-- jobJs/codeFunc.js --}}
<select onchange="code.workMediumCtg()" id="workLargeVal" class="form-control form-control-sm mx-2">
...
<select id="workMediumVal" class="form-control form-control-sm mx-2">
