              ...
              <div class="row">
                <table  style="width:100%">
                  <tbody>
                    <tr role="row" class="odd">
                      <td rowspan="2" style="width:20%;">작업 명</td>
                    ...
                    <tr role="row" class="even">
                      ...
                      <td>상태</td>
                      <td colspan="2"><input class="form-control text-center" type="text" placeholder=" - "></td>
                    </tr>
                  </tbody>
                </table>
                <hr class="col-md-12">
                  ...
                  <tbody>
                    <tr role="row" class="odd">
                      ...
                      <td rowspan="2" style="width:20%;"><input type="checkbox" checked="checked" id="vehicle1" name="vehicle1" value="Bike">
                        <label for="vehicle1">프로세스 명1</label><i class="fa fa-info-circle" onclick="processDetailInfo()"></i></td>
                      <td><select class="form-control"><optgroup label="parameter1"><option>선택</option><option>parameter1</option></optgroup></select></td>
                      ...
                      <td><select class="form-control"><optgroup label="parameter4"><option>선택</option><option>parameter4</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter5"><option>선택</option><option>parameter5</option></optgroup></select></td>
                      <td rowspan="2" class="form-control" style="width:10% !important; display: table-cell !important;"> 재작업 </td>
                    </tr>
                    <tr role="row" class="even">
                      <td><select class="form-control"><optgroup label="parameter6"><option>선택</option><option>parameter6</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter7"><option>선택</option><option>parameter7</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter8"><option>선택</option><option>parameter8</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter9"><option>선택</option><option>parameter9</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter10"><option>선택</option><option>parameter10</option></optgroup></select></td>
                    </tr>
                  </tbody>
                </table>
                <table class="mb-2" style="width:100%">
                  <tbody>
                    <tr role="row" class="odd">
                      <td rowspan="2" style="width:20%;"><input type="checkbox" checked="checked" id="vehicle1" name="vehicle1" value="Bike">
                        <label for="vehicle1">프로세스 명2</label><i class="fa fa-info-circle"></i></td>
                      <td><select class="form-control"><optgroup label="parameter1"><option>선택</option><option>parameter1</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter2"><option>선택</option><option>parameter2</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter3"><option>선택</option><option>parameter3</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter4"><option>선택</option><option>parameter4</option></optgroup></select></td>
                ...
                <table class="mb-2" style="width:100%">
                  <tbody>
                    <tr role="row" class="odd">
                      <td rowspan="2" style="width:20%;"><input type="checkbox" checked="checked" id="vehicle1" name="vehicle1" value="Bike">
                        <label for="vehicle1">프로세스 명3</label><i class="fa fa-info-circle"></i></td>
                      <td><select class="form-control"><optgroup label="parameter1"><option>선택</option><option>parameter1</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter2"><option>선택</option><option>parameter2</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter3"><option>선택</option><option>parameter3</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter4"><option>선택</option><option>parameter4</option></optgroup></select></td>
                ...
                <table class="mb-2" style="width:100%">
                  <tbody>
                    <tr role="row" class="odd">
                      <td rowspan="2" style="width:20%;"><input type="checkbox" checked="checked" id="vehicle1" name="vehicle1" value="Bike">
                        <label for="vehicle1">프로세스 명4</label><i class="fa fa-info-circle"></i></td>
                      <td><select class="form-control"><optgroup label="parameter1"><option>선택</option><option>parameter1</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter2"><option>선택</option><option>parameter2</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter3"><option>선택</option><option>parameter3</option></optgroup></select></td>
                      <td><select class="form-control"><optgroup label="parameter4"><option>선택</option><option>parameter4</option></optgroup></select></td>
