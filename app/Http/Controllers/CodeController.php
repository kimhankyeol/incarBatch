...
class CodeController extends Controller
{
    ...
    public function workLargeCtg(Request $request){
        ...
        $workLargeCtgData=DB::table('OnlineBatch_CommonCode')->where('Codetype', $Codetype)->where('WorkMedium', $WorkMedium)->get();
    ...
    public function workMediumCtg(Request $request){
        ...
        $workMediumCtgData=DB::table('OnlineBatch_CommonCode')->where('Codetype', $Codetype)->where('WorkLarge', $WorkLarge)->where('WorkMedium','!=' ,'all')->get();
